...
class plant:
    ...
    def Plant(self, P1, P2, P3, P4, P5, P6, k, HMI):
        ...
        self.p = {
            ...
            "S_t601": 1.5 * 1000000,
            "S_t602": 1.5 * 1000000,
            "f_p101": 2.0 * 1000000000 / 3600,
            "f_mv201": 2.0 * 1000000000 / 3600,
            "f_p301": 2.0 * 1000000000 / 3600,
            "f_mv302": 2.0 * 1000000000 / 3600,
            "f_p602": 2.0 * 1000000000 / 3600,
            "f_p401": 2.0 * 1000000000 / 36001,
            "f_mv501": 2.0 * 1000000000 / 3600,
            "f_mv502": 0.00006111,
            "f_mv503": 0.00049,
            "f_p601": 2.0 * 1000000000 / 36001,
            "LIT101_AL": 0.2,
            "LIT101_AH": 0.8,
            "LIT301_AL": 0.2,
            "LIT301_AH": 0.8,
        ...
        if (
            ...
            and P3.MV303.DI_ZSC
            and P3.MV304.DO_ZSO
            and P6.P602.DI_Run == 0
        ):  # UF flushing procedure, 30 sec
            pass
        if (
            P3.P301.DI_Run == 1
            or P3.P302.DI_Run == 1
            and P3.MV301.DI_ZSC == 1
            and P3.MV302.DI_ZSO == 1
            and P3.MV303.DI_ZSC == 1
            and P3.MV304.DI_ZSC == 1
            and P6.P602.DI_Run == 0
        ...
        if (
            P3.P301.DI_Run == 0
            and P3.P302.DI_Run == 0
            and P3.MV301.DI_ZSO == 1
            and P3.MV302.DI_ZSC == 1
            and P3.MV303.DI_ZSO == 1
            and P3.MV304.DI_ZSC == 1
            and P6.P602.DI_Run == 1
        ...
        if (
            ...
            and P3.MV302.DI_ZSC == 1
            and P3.MV303.DI_ZSC == 1
            and P3.MV304.DI_ZSO == 1
            and P6.P602.DI_Run == 0
        ):  # UF feed tank draining procedure, 1 min
            pass
        ...
        if (
            P4.P401.DI_Run == 1
            or P4.P402.DI_Run == 1
            and P5.P501.DI_Run == 1
            or P5.P502.DI_Run == 1
            and P5.MV501.DI_ZSO == 1
            and P5.MV502.DI_ZSO == 1
            and P5.MV503.DI_ZSC == 1
            and P5.MV504.DI_ZSC == 1
            ...
            and P5.P501.DI_Run == 1
            or P5.P502.DI_Run == 1
            and P5.MV501.DI_ZSC == 1
            and P5.MV502.DI_ZSC == 1
            and P5.MV503.DI_ZSO == 1
            and P5.MV504.DI_ZSO == 1
