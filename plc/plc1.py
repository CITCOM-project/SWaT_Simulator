...
class plc1:
    ...
    def Pre_Main_Raw_Water(self, IO, HMI):
        ...
        HMI.PLANT.Ready = (
            HMI.P1.Permissive_On
            and HMI.P2.Permissive_On
            and HMI.P3.Permissive_On
            and HMI.P4.Permissive_On
        )
        # self.TON_FIT102_P1_TM = TONR(10)
        # self.TON_FIT102_P2_TM = TONR(10)
        ...
        if HMI.P1.State == 1:
            ...
            self.Mid_MV101_AutoInp = SETD(
                HMI.LIT101.AL, HMI.LIT101.AH, self.Mid_MV101_AutoInp
            )
            self.Mid_P_RAW_WATER_DUTY_AutoInp = SETD(
                HMI.MV201.Status == 2 and HMI.LIT301.AL,
        ...
        self.P_RAW_WATER_DUTY_FB.Duty2_FBD(
            self.Mid_P_RAW_WATER_DUTY_AutoInp, HMI.P101, HMI.P102, HMI.P_RAW_WATER_DUTY
        )
