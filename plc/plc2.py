...
class plc2:
    ...
    def Pre_Main_UF_Feed_Dosing(self, IO, HMI):
        ...
        HMI.P2.Permissive_On = (
            HMI.MV201.Avl
            and (HMI.P201.Avl or HMI.P202.Avl)
            and (HMI.P203.Avl or HMI.P204.Avl)
            and (HMI.P205.Avl or HMI.P206.Avl)
        )

        self.Mid_FIT201_Tot_Enb = HMI.MV201.Status == 2

        self.TON_FIT102_P1_TM.TONR(
            HMI.FIT201.ALL and HMI.MV201.Status == 2 and HMI.P201.Status == 2
        )
        self.TON_FIT102_P2_TM.TONR(
            HMI.FIT201.ALL and HMI.MV201.Status == 2 and HMI.P202.Status == 2
        )
        self.TON_FIT102_P3_TM.TONR(
            HMI.FIT201.ALL and HMI.MV201.Status == 2 and HMI.P203.Status == 2
        )
        self.TON_FIT102_P4_TM.TONR(
            HMI.FIT201.ALL and HMI.MV201.Status == 2 and HMI.P204.Status == 2
        )
        self.TON_FIT102_P5_TM.TONR(
            HMI.FIT201.ALL and HMI.MV201.Status == 2 and HMI.P205.Status == 2
        )
        self.TON_FIT102_P6_TM.TONR(
            HMI.FIT201.ALL and HMI.MV201.Status == 2 and HMI.P206.Status == 2
        )
        ...
        # def Main(self)
        if (
            HMI.PLANT.Stop or HMI.PLANT.Critical_SD_On
        ):  # the HMI.PLANT.Critical_SD_On variable could be rethought, currently it's defined in HMI
            HMI.P2.Shutdown = 1
        ...
        if HMI.P2.State == 1:
            ...
            self.Mid_MV201_AutoInp = SETD(
                HMI.LIT301.AL, HMI.LIT301.AH, self.Mid_MV201_AutoInp
            )

            # (*P-201/2 , Cond NACL Dosing Pump Control*)
            self.Mid_P_NACL_DUTY_AutoInp = SETD(
                HMI.MV201.Status == 2 and (HMI.AIT201.AL) and (not HMI.AIT503.AH),
                HMI.MV201.Status != 2
                or (HMI.AIT201.AH)
                or (HMI.AIT503.AH)
                or HMI.LS201.Alarm
            ...
            self.Mid_P_HCL_DUTY_AutoInp = SETD(
                HMI.MV201.Status == 2 and (HMI.AIT202.AH),
                HMI.MV201.Status != 2
                or (HMI.AIT202.AL)
                or HMI.LS202.Alarm
                or HMI.FIT201.ALL,
            ...
            self.Mid_P_NAOCL_FAC_DUTY_AutoInp = SETD(
                HMI.MV201.Status == 2 and (HMI.AIT203.AL) and (not HMI.AIT402.AH),
                HMI.MV201.Status != 2
                or (HMI.AIT203.AH)
                or (HMI.AIT402.AH)
                or HMI.LSL203.Alarm,
        ...
        self.P_NACL_DUTY_FB.Duty2_FBD(
            self.Mid_P_NACL_DUTY_AutoInp, HMI.P201, HMI.P202, HMI.P_NACL_DUTY
        )
        self.P_HCL_DUTY_FB.Duty2_FBD(
            self.Mid_P_HCL_DUTY_AutoInp, HMI.P203, HMI.P204, HMI.P_HCL_DUTY
        )
        self.P_NAOCL_FAC_DUTY_FB.Duty2_FBD(
            self.Mid_P_NAOCL_FAC_DUTY_AutoInp, HMI.P205, HMI.P206, HMI.P_NAOCL_FAC_DUTY
        )
