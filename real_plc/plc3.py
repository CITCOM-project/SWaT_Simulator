...
class plc3:
    ...
    def Pre_Main_UF_Feed(self, IO, HMI, Sec_P, Min_P):
        ...
        HMI.P3.Permissive_On = (
            HMI.MV301.Avl
            and HMI.MV302.Avl
            and HMI.MV303.Avl
            and HMI.MV304.Avl
            and (HMI.P301.Avl or HMI.P302.Avl)
        )
        ...
        HMI.P301.SD[4] = (
            HMI.P301.Status == 2 and HMI.MV302.Status != 2 and HMI.MV304.Status != 2
        )
        ...
        HMI.P302.SD[4] = (
            HMI.P302.Status == 2 and HMI.MV302.Status != 2 and HMI.MV304.Status != 2
        )
        ...
        while switch(HMI.P3.State):
            ...
            if case(4):
                ...
                if (
                    HMI.Cy_P3.UF_REFILL_SEC > HMI.Cy_P3.UF_REFILL_SEC_SP
                    or self.Mid_NEXT
                ):
                    self.Mid_NEXT = 0
                    HMI.P3.State = 5
            ...
            if case(7):
                ...
                if (
                    HMI.Cy_P3.UF_FILTRATION_MIN >= HMI.Cy_P3.UF_FILTRATION_MIN_SP
                    or self.Mid_NEXT
                ):
                    self.Mid_NEXT = 0
                    HMI.P3.State = 8
            ...
            if case(18):
                ...
                if (
                    HMI.Cy_P3.CIP_CLEANING_SEC > HMI.Cy_P3.CIP_CLEANING_SEC_SP
                    or self.Mid_NEXT
                ):
                    self.Mid_NEXT = 0
                    HMI.P3.State = 19
        ...
        # 	def UF_Feed(self):
        self.P_UF_FEED_DUTY_FB.Duty2_FBD(
            self.Mid_P_UF_FEED_DUTY_AutoInp, HMI.P301, HMI.P302, HMI.P_UF_FEED_DUTY
        )
