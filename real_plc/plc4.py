...
class plc4:
    ...
    def Pre_Main_RO_Feed_Dosing(self, IO, HMI):
        ...
        HMI.P4.Permissive_On = (
            (HMI.P401.Avl or HMI.P402.Avl)
            and (HMI.P403.Avl or HMI.P404.Avl)
            and HMI.UV401.Avl
        )

        self.Mid_FIT401_Tot_Enb = HMI.P401.Status == 2 or HMI.P402.Status == 2

        self.TON_FIT401_TM.TONR(
            (HMI.P401.Status == 2 or HMI.P402.Status == 2) and HMI.FIT401.ALL
        )
        ...
        HMI.P401.Permissive[1] = (
            HMI.MV501.Status == 2
            or HMI.MV502.Status == 2
            or HMI.MV503.Status == 2
            or HMI.MV504.Status == 2
        )
        ...
        HMI.P401.SD[2] = (
            HMI.P401.Status == 2
            and HMI.MV501.Status != 2
            and HMI.MV502.Status != 2
            and HMI.MV503.Status != 2
        ...
        HMI.P403.SD[1] = (
            HMI.P401.Status == 2 or HMI.P402.Status == 2
        ) and HMI.FIT401.ALL
        ...
        if HMI.P4.State == 2:
            ...
            self.Mid_P_RO_FEED_DUTY_AutoInp = (
                HMI.MV503.Status == 2 and HMI.MV504.Status == 2
            )
            self.Mid_P_NAHSO3_ORP_DUTY_AutoInp = 0
        ...
        if HMI.P4.State == 5:
            self.Mid_UV401_AutoInp = 1
            self.Mid_P_RO_FEED_DUTY_AutoInp = (
                HMI.MV503.Status == 1 and HMI.MV504.Status == 1
            )
            self.Mid_P_NAHSO3_ORP_DUTY_AutoInp = 0
        ...
        # RO_Feed_Dosing
        self.P_RO_FEED_DUTY_FB.Duty2_FBD(
            self.Mid_P_RO_FEED_DUTY_AutoInp, HMI.P401, HMI.P402, HMI.P_RO_FEED_DUTY
        )
