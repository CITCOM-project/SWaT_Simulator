...
class plc5:
    ...
    def Pre_Main_High_Pressure_RO(self, IO, HMI, Sec_P, Min_P):
        ...
        HMI.P5_Permissive_On = (
            (HMI.P501.Avl or HMI.P502.Avl)
            and HMI.MV501.Avl
            and HMI.MV502.Avl
            and HMI.MV503.Avl
            and HMI.MV504.Avl
        ...
        HMI.Cy_P5.MIN_RO_VSD_SPEED = (
            HMI.Cy_P5.HPP_Q_SET_M3H / HMI.Cy_P5.HPP_Q_MAX_M3H * 50 * 0.1
        )
        ...
        while switch(HMI.P5.State):
            ...
            if case(3):
                ...
                if (
                    HMI.MV503.Status == 2
                    and HMI.MV504.Status == 2
                    and HMI.P_RO_FEED_DUTY.Pump_Running
                    or self.Mid_NEXT
                ):
                    self.Mid_NEXT = 0
                    HMI.P5.State = 4
            ...
            if case(5):
                ...
                HMI.Cy_P5.MV504_TIMEOUT_TM = 0
                if (
                    (HMI.P501.Speed >= self.Mid_P50X_AutoSpeed)
                    or (HMI.P502.Speed >= self.Mid_P50X_AutoSpeed)
                    or self.Mid_NEXT
                ):
                    self.Mid_NEXT = 0
                    HMI.P5.State = 6
            ...
            if case(6):
                ...
                if (
                    (
                        (HMI.FIT501.Pv > HMI.Cy_P5.HPP_Q_SET_M3H)
                        and (HMI.PIT502.Pv < HMI.PIT503.Pv)
                    )
                    and HMI.PIT501.Pv > 250
                    or self.Mid_NEXT
                ):
                    self.Mid_NEXT = 0
                    HMI.P5.State = 7
            ...
            if case(13):
                ...
                if self.Mid_P50X_AutoSpeed > HMI.Cy_P5.VSD_MIN_SPEED:
                    if Sec_P:
                        self.Mid_P50X_AutoSpeed = self.Mid_P50X_AutoSpeed - 0.5
                if (
                    (HMI.P501.Speed <= HMI.Cy_P5.VSD_MIN_SPEED)
                    and (HMI.P502.Speed <= HMI.Cy_P5.VSD_MIN_SPEED)
                    or self.Mid_NEXT
                ):
                    self.Mid_NEXT = 0
                    HMI.P5.State = 14
            ...
            if case(15):
                ...
                if (
                    HMI.MV504.Status == 2
                    or self.Mid_NEXT
                    or HMI.Cy_P5.MV504_TIMEOUT_TM > 120
                ):
                    self.Mid_NEXT = 0
                    HMI.P5.State = 16
                break
            if case(16):
                ...
                if (
                    HMI.MV502.Status == 1
                    or self.Mid_NEXT
                    or HMI.Cy_P5.MV502_TIMEOUT_TM > 120
                ):
                    self.Mid_NEXT = 0
                    HMI.P5.State = 17
                break
            if case(17):
                ...
                if (
                    HMI.MV503.Status == 2
                    or self.Mid_NEXT
                    or HMI.Cy_P5.MV503_TIMEOUT_TM > 120
                ):
                    self.Mid_NEXT = 0
                    HMI.P5.State = 18
                break
            if case(18):
                ...
                if (
                    HMI.MV501.Status == 1
                    or self.Mid_NEXT
                    or HMI.Cy_P5.MV501_TIMEOUT_TM > 120
                ):
                    self.Mid_NEXT = 0
                    HMI.P5.State = 19
                break
            if case(19):
                ...
                HMI.Cy_P5.MV504_TIMEOUT_TM = 0
                if (
                    HMI.Cy_P5.RO_SD_FLUSHING_MIN > HMI.Cy_P5.RO_SD_FLUSHING_MIN_SP
                    or self.Mid_NEXT
                ):
                    self.Mid_NEXT = 0
                    HMI.P5.State = 20
        ...
        self.P501_FB.VSD_FBD(
            self.P_RO_HIGH_DUTY_FB.Start_Pmp1,
            self.Mid_P50X_AutoSpeed,
            IO.P501_VSD_In,
            IO.P501_VSD_Out,
            IO.P501,
            HMI.P501,
        )
        self.P502_FB.VSD_FBD(
            self.P_RO_HIGH_DUTY_FB.Start_Pmp2,
            self.Mid_P50X_AutoSpeed,
            IO.P502_VSD_In,
            IO.P502_VSD_Out,
            IO.P502,
        ...
        self.P_RO_HIGH_DUTY_FB.Duty2_FBD(
            self.Mid_P_RO_HIGH_AutoInp, HMI.P501, HMI.P502, HMI.P_RO_HIGH_DUTY
        )
